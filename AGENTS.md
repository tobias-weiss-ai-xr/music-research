...
Data-driven, auto-validated literature review corpus for **music research**
(AI music generation, music information retrieval, music perception &
cognition, AI music systems & agents, evaluation, and surveys — across
symbolic, audio, multimodal and agentic work). The repo is built from the
`skeleton-research` template: papers live in `papers.yaml`, everything else
is generated.
...
config/other_sources_queries.yaml ← dblp/crossref/europepmc/openalex queries
